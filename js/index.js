...
function changeBackgroundPC() {
    switch (currentBackground) {
        case 0:
            background.style.background = "white url(img/circuito_competición_negro.png) no-repeat center/ auto 40vh";
            nameCircuit.innerHTML = "<polygon points='-75,0 175,0 75,100 25,100' /> <text class='text-top' x='30%' y='97%'>Circuito Competición</text>";
            break;
        case 1:
            background.style.background = "white url(img/circuito_indoor_negro.png) no-repeat center/ auto 40vh";
            nameCircuit.innerHTML = "<polygon points='-75,0 175,0 75,100 25,100' /> <text class='text-top' x='36%' y='97%'>Circuito Indoor</text>";
            break;
        case 2:
            background.style.background = "white url(img/circuito_outdoor_negro.png) no-repeat center/ auto 40vh";
